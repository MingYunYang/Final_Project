...
public class MainScreen extends javax.swing.JPanel {
    ...
    private void initUserWorkArea() {
        lblWelcome.setText("Welcome to "
                ...
                + ((userAccount.getOrganizationEmployee().getEmployeeName() != null) ? userAccount.getOrganizationEmployee().getEmployeeName() : userAccount.getUsername())
                + "!");

        CardLayout layout = (CardLayout) workArea.getLayout();
        workArea.add("workArea", userAccount.getOrganizationEmployeeRole().createWorkArea(workArea, userAccount, organization, ecosystem));
