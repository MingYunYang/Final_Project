...
import nvds.Organization.NvdsAdminOrganization;
...
import nvds.Role.EmployeeRole.EmployeeRoleType;
...
public class NationalVaccineDistributionSystemConfiguration {
    ...
    public static NationalVaccineDistributionSystem configure() {
        ...
        EmployeeRole admin1 = nvdsAdminOrganization.setSupportedEmployeeRole(EmployeeRoleType.NVDS_ADMIN_ORG_ADMIN_ROLE);
        ...
        EmployeeRole admin2 = nvdsAdminOrganization.setSupportedEmployeeRole(EmployeeRoleType.NVDS_ADMIN_ORG_ADMIN_ROLE);
        // Create user account for MING an employee of the admin organization
        ...
        // get supported role
        EmployeeRole clinicVaccineInventoryManagementRole = havardSquareClinic.setSupportedEmployeeRole(EmployeeRoleType.VACCINE_INVENTORY_MANAGEMENT_ROLE);
        // create user acount
        ...
        // get supported role
        EmployeeRole clinicReviewVaccineOrderRequestRole = havardSquareClinic.setSupportedEmployeeRole(EmployeeRoleType.REVIEW_VACCINE_ORDER_REQUEST_ROLE);
        // create user account
        ...
        // get supported roles
        EmployeeRole clinicDoctorRole = havardSquareClinic.setSupportedEmployeeRole(EmployeeRoleType.CLINIC_DOCTOR_ROLE);
        // create user account
        ...
        // get supported role
        EmployeeRole hospitalVaccineInventoryManagementRole = cambridgeHospital.setSupportedEmployeeRole(EmployeeRoleType.VACCINE_INVENTORY_MANAGEMENT_ROLE);
        // create user account
        ...
        // get supported role
        EmployeeRole hospitalReviewVaccineOrderRequestRole = cambridgeHospital.setSupportedEmployeeRole(EmployeeRoleType.REVIEW_VACCINE_ORDER_REQUEST_ROLE);
        // create user account
        ...
        // get supported role
        EmployeeRole hospitalLabRole = cambridgeHospital.setSupportedEmployeeRole(EmployeeRoleType.HOSPITAL_LAB_TECHNICIAN_ROLE);
        // create user account
